...
class Firewall (EventMixin):
	...
	#msg.match = match
	self.eventSwitch.connection.send(msg) #no action so drop all packets with srcmac because this host is infected and not exempted


    def foward_gardenwall(self, flow):
	msg = of.ofp_flow_mod()
	msg.match.dl_src = EthAddr(str(flow['srcmac']))
	...
	srcdest_field = EthAddr('00:00:00:00:00:03')
	#msg.match.dl_type = 0x0800
	
	#msg.match.nw_dst = IPAddr("10.0.0.3") #all packet  destination ip dst part rewriting 10.0.0.3
